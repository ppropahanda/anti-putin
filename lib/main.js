...
pageMod.PageMod({
    ...
    onAttach: function (worker) {
        // TODO: fix handling of external resources (JS, CSS, Images, Video...)
        // XXX: have to look at https://dev.mozilla.jp/addon-sdk-docs/packages/addon-kit/page-mod.html
        console.log("!!! Worker: ", worker);
        console.log("!!! Worker Tab: ", worker.tab);
        console.log("!!! Title: ", worker.tab.title);
        console.log("!!! Url: ", worker.tab.url);
